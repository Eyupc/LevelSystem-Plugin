...
import com.master.websocket.communication.outgoing.messages.ShowTopListEvent;
import gnu.trove.map.hash.THashMap;
import io.netty.channel.Channel;

import java.sql.SQLException;

public class RequestTopListEvent extends IncomingMessage {

    public RequestTopListEvent(String header, THashMap<String,Object> data, Channel client) throws SQLException {
    ...
    public void execute() throws SQLException {
        ...
        if (client != null) {
            ...
            client.send(new ShowTopListEvent(player));
        }
    }
}
